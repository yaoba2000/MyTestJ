...
//
//            ks.load(new FileInputStream("D:\\keys\\kserver.keystore"), SERVER_KEY_STORE_PASSWORD.toCharArray());
//            tks.load(new FileInputStream("D:\\keys\\tserver.keystore"), SERVER_TRUST_KEY_STORE_PASSWORD.toCharArray());
//
...
//            serverSocket = (SSLServerSocket) ctx.getServerSocketFactory().createServerSocket(DEFAULT_PORT);
            serverSocket = (SSLServerSocket) SecureChatSslContextFactory.getServerContext().getServerSocketFactory().createServerSocket(DEFAULT_PORT);
